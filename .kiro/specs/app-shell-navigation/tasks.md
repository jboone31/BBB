...
- [x] 2. Implement the persistent branded header (`components/shell/HeaderNav.tsx`)
  - [x] 2.1 Implement `HeaderNav` server component
  ...
  - [x] 2.2 Write component render test `components/shell/HeaderNav.test.tsx`
    - Assert logo `alt`, tagline text present, and the brand link resolves to `/`
    - _Requirements: 1.2, 1.3, 1.4_

- [x] 3. Extend the root layout into the App_Shell (`app/layout.tsx`)
...
- [x] 4. Checkpoint - shell renders on every route
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implement the code → gameId resolution route (`app/api/games/resolve/route.ts`, NEW)
  - [x] 5.1 Implement `POST` handler (`runtime = "nodejs"`)
  ...
  - [x] 5.2 Write property test `app/api/games/resolve/route.property.test.ts` for uniform not-found
  ...
  - [x] 5.3 Write property test in `app/api/games/resolve/route.property.test.ts` for only-id-in-response
  ...
  - [x] 5.4 Write property test in `app/api/games/resolve/route.property.test.ts` for normalization invariance
  ...
  - [x] 5.5 Write unit tests for resolution edge cases
...
- [x] 6. Implement the Host entry control (`components/shell/HostEntry.tsx`)
...
- [x] 7. Implement the Join-by-code entry control (`components/shell/JoinEntry.tsx`, client component)
  - [x] 7.1 Implement `JoinEntry` client component
  ...
  - [x] 7.2 Write property test `components/shell/JoinEntry.property.test.tsx` for malformed-code short-circuit
  ...
  - [x] 7.3 Write interaction tests for JoinEntry (mocked router + fetch)
...
- [x] 8. Implement the branded Landing_Page (`app/page.tsx`)
  ...
  - [x] 8.1 Write landing render test (`app/page.smoke.test.tsx` or a new render test)
...
- [x] 9. Wire the lobby `?code=` prefill (`app/games/[gameId]/lobby/page.tsx`)
  ...
  - [x] 9.1 Write interaction test for lobby prefill precedence
...
- [x] 10. Add mobile-first shell + landing CSS (`app/globals.css`)
  ...
  - [x] 10.1 Write viewport tests (`app/page.viewport.test.tsx` + `components/shell/HeaderNav.viewport.test.tsx`)
...
- [x] 11. Final checkpoint - shell, entry points, and resolution wired end to end
  - Ensure all tests pass, ask the user if questions arise.
